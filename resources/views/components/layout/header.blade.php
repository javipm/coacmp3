<header class="relative container mx-auto flex items-center justify-between py-5 z-10">
    ...
    <nav class="hidden lg:block sm:hidden">
        ...
        [&>li>a:hover]:scale-110">
            ...
            <li><a wire:navigate href="{{ route('modality', 'comparsas') }}">Comparsas</a></li>
            <li><a wire:navigate href="{{ route('modality', 'chirigotas') }}">Chirigotas</a></li>
            <li><a wire:navigate href="{{ route('modality', 'coros') }}">Coros</a></li>
            <li><a wire:navigate href="{{ route('modality', 'cuartetos') }}">Cuartetos</a></li>
        </ul>
    </nav>

    <div class="flex basis-0 justify-end">
        <a wire:navigate href="{{ route('search') }}" title="Búsqueda" class=" h-6 w-6 text-orange-700 cursor-pointer transition
